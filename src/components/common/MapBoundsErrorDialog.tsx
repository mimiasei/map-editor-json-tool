...
export default function MapBoundsErrorDialog() {
  ...
  const message = violations
    ? [
        "The following object(s) extend past the map's edge and can't be saved — move them first:",
        '',
  ...
  return (
    <Dialog open={violations !== null} onOpenChange={(o) => { if (!o) clearBoundsViolations() }}>
