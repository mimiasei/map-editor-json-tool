...
**Desktop downloads (v0.7.9):**

| Platform | Download |
|---|---|
| macOS — Apple Silicon | [HommOE.Scenario.Editor_0.7.9_aarch64.dmg](https://github.com/mimiasei/map-editor-json-tool/releases/download/v0.7.9/HommOE.Scenario.Editor_0.7.9_aarch64.dmg) |
| Windows | [HommOE.Scenario.Editor_0.7.9_x64-setup.exe](https://github.com/mimiasei/map-editor-json-tool/releases/download/v0.7.9/HommOE.Scenario.Editor_0.7.9_x64-setup.exe) |
| Linux | [HommOE.Scenario.Editor_0.7.9_amd64.AppImage](https://github.com/mimiasei/map-editor-json-tool/releases/download/v0.7.9/HommOE.Scenario.Editor_0.7.9_amd64.AppImage) |
