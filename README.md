...
**Desktop downloads (v0.6.10):**

| Platform | Download |
|---|---|
| macOS — Apple Silicon | [HommOE.Scenario.Editor_0.6.10_aarch64.dmg](https://github.com/mimiasei/map-editor-json-tool/releases/download/v0.6.10/HommOE.Scenario.Editor_0.6.10_aarch64.dmg) |
| Windows | [HommOE.Scenario.Editor_0.6.10_x64-setup.exe](https://github.com/mimiasei/map-editor-json-tool/releases/download/v0.6.10/HommOE.Scenario.Editor_0.6.10_x64-setup.exe) |
| Linux | [HommOE.Scenario.Editor_0.6.10_amd64.AppImage](https://github.com/mimiasei/map-editor-json-tool/releases/download/v0.6.10/HommOE.Scenario.Editor_0.6.10_amd64.AppImage) |
