...
**Desktop downloads (v0.7.4):**

| Platform | Download |
|---|---|
| macOS — Apple Silicon | [HommOE.Scenario.Editor_0.7.4_aarch64.dmg](https://github.com/mimiasei/map-editor-json-tool/releases/download/v0.7.4/HommOE.Scenario.Editor_0.7.4_aarch64.dmg) |
| Windows | [HommOE.Scenario.Editor_0.7.4_x64-setup.exe](https://github.com/mimiasei/map-editor-json-tool/releases/download/v0.7.4/HommOE.Scenario.Editor_0.7.4_x64-setup.exe) |
| Linux | [HommOE.Scenario.Editor_0.7.4_amd64.AppImage](https://github.com/mimiasei/map-editor-json-tool/releases/download/v0.7.4/HommOE.Scenario.Editor_0.7.4_amd64.AppImage) |
