...
**Desktop downloads (v0.7.3):**

| Platform | Download |
|---|---|
| macOS — Apple Silicon | [HommOE.Scenario.Editor_0.7.3_aarch64.dmg](https://github.com/mimiasei/map-editor-json-tool/releases/download/v0.7.3/HommOE.Scenario.Editor_0.7.3_aarch64.dmg) |
| Windows | [HommOE.Scenario.Editor_0.7.3_x64-setup.exe](https://github.com/mimiasei/map-editor-json-tool/releases/download/v0.7.3/HommOE.Scenario.Editor_0.7.3_x64-setup.exe) |
| Linux | [HommOE.Scenario.Editor_0.7.3_amd64.AppImage](https://github.com/mimiasei/map-editor-json-tool/releases/download/v0.7.3/HommOE.Scenario.Editor_0.7.3_amd64.AppImage) |
