...
**Desktop downloads (v0.9.0):**

| Platform | Download |
|---|---|
| macOS — Apple Silicon | [HommOE.Scenario.Editor_0.9.0_aarch64.dmg](https://github.com/mimiasei/map-editor-json-tool/releases/download/v0.9.0/HommOE.Scenario.Editor_0.9.0_aarch64.dmg) |
| Windows | [HommOE.Scenario.Editor_0.9.0_x64-setup.exe](https://github.com/mimiasei/map-editor-json-tool/releases/download/v0.9.0/HommOE.Scenario.Editor_0.9.0_x64-setup.exe) |
| Linux | [HommOE.Scenario.Editor_0.9.0_amd64.AppImage](https://github.com/mimiasei/map-editor-json-tool/releases/download/v0.9.0/HommOE.Scenario.Editor_0.9.0_amd64.AppImage) |
