...
**Desktop downloads (v0.5.2):**

| Platform | Download |
|---|---|
| macOS — Apple Silicon | [HommOE.Scenario.Editor_0.5.2_aarch64.dmg](https://github.com/mimiasei/map-editor-json-tool/releases/download/v0.5.2/HommOE.Scenario.Editor_0.5.2_aarch64.dmg) |
| macOS — Intel | [HommOE.Scenario.Editor_0.5.2_x64.dmg](https://github.com/mimiasei/map-editor-json-tool/releases/download/v0.5.2/HommOE.Scenario.Editor_0.5.2_x64.dmg) |
| Windows | [HommOE.Scenario.Editor_0.5.2_x64-setup.exe](https://github.com/mimiasei/map-editor-json-tool/releases/download/v0.5.2/HommOE.Scenario.Editor_0.5.2_x64-setup.exe) |
| Linux | [HommOE.Scenario.Editor_0.5.2_amd64.AppImage](https://github.com/mimiasei/map-editor-json-tool/releases/download/v0.5.2/HommOE.Scenario.Editor_0.5.2_amd64.AppImage) |
